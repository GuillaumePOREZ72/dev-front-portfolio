  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          className="text-xl mt-10 mb-8 text-gray-700 dark:text-gray-300"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.button
          className="bg-secondary-light dark:bg-secondary-dark text-white dark:text-gray-900 mt-8 px-8 py-4 rounded-full font-bold text-xl transition-colors duration-300 hover:bg-tertiary-light dark:hover:bg-tertiary-dark"
          whileHover={{
            scale: 1.05,
            rotate: [0, 2, -2, 0],
